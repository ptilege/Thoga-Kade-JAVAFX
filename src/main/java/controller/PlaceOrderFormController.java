...
public class PlaceOrderFormController {
    ...
    public void addToCartButtonOnAction(ActionEvent actionEvent) {
        try {
            ItemDto itemDto = itemModel.getItem(cmbItemCode.getValue().toString());
            int requestedQty = Integer.parseInt(txtQty.getText());

            if (itemDto != null && requestedQty <= itemDto.getQty()) {
                double amount = itemDto.getUnitPrice() * requestedQty;
                ...
                // Update quantity on hand in the ItemModel
                itemModel.updateItemQty(itemDto.getCode(), itemDto.getQty() - requestedQty);
                ...
                new Alert(Alert.AlertType.ERROR, "Invalid quantity requested or item not available!").show();
            }
